...
export const GosabaHeritagePage: React.FC<GosabaHeritagePageProps> = ({ onNavigate }) => {
  ...
  const steps = [
    { id: 0, titleBn: '১. ঐতিহাসিক সংশোধন', titleEn: '1. Historic Correction', icon: AlertTriangle },
    { id: 1, titleBn: '২. সুন্দরবনের অন্য ইতিহাস', titleEn: '2. Sundarban Social History', icon: History },
    { id: 2, titleBn: '৩. স্যার ড্যানিয়েল হ্যামিল্টন', titleEn: '3. Sir Daniel Hamilton', icon: Landmark },
    { id: 3, titleBn: '৪. রবীন্দ্রনাথ ও চিন্তার মিল', titleEn: '4. Tagore & Shared Ideals', icon: BookOpen },
    { id: 4, titleBn: '৫. ১৯৩২-এর ঐতিহাসিক সফর', titleEn: '5. Tagore 1932 Visit', icon: Calendar },
    { id: 5, titleBn: '৬. বাংলোর সঠিক তথ্য', titleEn: '6. Where Tagore Stayed', icon: Building },
    { id: 6, titleBn: '৭. বাংলোর বিশেষত্ব ও স্থাপত্য', titleEn: '7. Bungalow Architecture', icon: Scale },
    { id: 7, titleBn: '৮. হেরিটেজ ট্যুর গাইড', titleEn: '8. Gosaba Tour Guide', icon: Compass },
  ];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
      ...
      {/* 🌟 3. Step-by-Step Interactive Navigation Bar */}
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-slate-500 font-medium hidden sm:inline-block">
            {isBengali ? 'যেকোনো ধাপে ক্লিক করে বিস্তারিত পড়ুন' : 'Click any step to navigate chapters'}
          </span>
        </div>
          ...
          {steps.map((step) => {
            ...
            return (
              ...
              >
                ...
                <span className="truncate">{isBengali ? step.titleBn : step.titleEn}</span>
              </button>
            );
          })}
        </div>
      ...
      {/* 🌟 4. Step Content Containers */}
      <div className="bg-white/95 backdrop-blur-md rounded-3xl p-6 sm:p-10 border border-white/60 shadow-xl space-y-8">
        
        {/* STEP 1: সুন্দরবনের ইতিহাসের অন্য এক অধ্যায় */}
        {(activeTab === 0 || activeTab === 1) && (
          <section className="space-y-4 border-b border-slate-200 pb-8 last:border-0 last:pb-0">
            ...
            <div className="p-5 bg-emerald-50/80 rounded-2xl border border-emerald-200 space-y-2 text-sm text-emerald-950">
              <strong className="block font-heading text-emerald-900 text-base">
        ...
        {/* STEP 2: Sir Daniel Hamilton কে ছিলেন? */}
        {(activeTab === 0 || activeTab === 2) && (
          <section className="space-y-4 border-b border-slate-200 pb-8 last:border-0 last:pb-0">
            <div className="flex items-center gap-2 text-xs font-bold text-amber-800 uppercase tracking-wider">
              <span className="px-2.5 py-1 rounded-full bg-amber-100 text-amber-900">ধাপ ২</span>
        ...
        {/* STEP 3: রবীন্দ্রনাথ ঠাকুর ও Hamilton-এর চিন্তার মিল */}
        {(activeTab === 0 || activeTab === 3) && (
          <section className="space-y-4 border-b border-slate-200 pb-8 last:border-0 last:pb-0">
            <div className="flex items-center gap-2 text-xs font-bold text-emerald-800 uppercase tracking-wider">
              <span className="px-2.5 py-1 rounded-full bg-emerald-100 text-emerald-900">ধাপ ৩</span>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
              <div className="p-3 bg-amber-50/90 rounded-xl border border-amber-200 font-semibold text-amber-950 text-center">
        ...
        {/* STEP 4: রবীন্দ্রনাথ ঠাকুরের গোসাবা সফর (ডিসেম্বর ১৯৩২) */}
        {(activeTab === 0 || activeTab === 4) && (
          <section className="space-y-4 border-b border-slate-200 pb-8 last:border-0 last:pb-0">
            <div className="flex items-center gap-2 text-xs font-bold text-purple-800 uppercase tracking-wider">
              <span className="px-2.5 py-1 rounded-full bg-purple-100 text-purple-900">ধাপ ৪</span>
        ...
        {/* STEP 5: রবীন্দ্রনাথ কোথায় ছিলেন? (সঠিক তথ্য বনাম ভুল দাবি) */}
        {(activeTab === 0 || activeTab === 5) && (
          <section className="space-y-4 border-b border-slate-200 pb-8 last:border-0 last:pb-0">
            <div className="flex items-center gap-2 text-xs font-bold text-rose-800 uppercase tracking-wider">
              <span className="px-2.5 py-1 rounded-full bg-rose-100 text-rose-900">ধাপ ৫</span>
        ...
        {/* STEP 7: Gosaba Heritage Tour-এ কী দেখবেন? */}
        {(activeTab === 0 || activeTab === 7) && (
          <section className="space-y-4">
            <div className="flex items-center gap-2 text-xs font-bold text-emerald-800 uppercase tracking-wider">
              <span className="px-2.5 py-1 rounded-full bg-emerald-100 text-emerald-900">ধাপ ৭</span>
